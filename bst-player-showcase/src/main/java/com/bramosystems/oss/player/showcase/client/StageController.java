 ...
 * @author Sikiru
 */
public class StageController extends Composite implements ValueChangeHandler<String>,
        PlaylistChangeHandler, HasMediaMessageHandlers { // PluginChangeHandler, PlayerOptionsChangeHandler
    ...
    public StageController() {
        ...
        providers.addChangeHandler(new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                players.clear();
                for (String pp : PlayerUtil.getPlayerNames(providers.getValue(providers.getSelectedIndex()))) {
                    players.addItem(pp);
                }
            }
        });
    ...
    public void onValueChange(ValueChangeEvent<String> event) {
        ...
        switch (loadedOption) {
            ...
            case widget:
                ...
                xforms.setVisible(false);
                panel.setWidget(null);
                break;
            case matrix:
                control.setVisible(true);
                xforms.setVisible(true);
                panel.setWidget(null);
        }
...
//                box.addItem("45 deg", "45");
    ...
    @UiField CheckBox controls, resizeToVideo, shuffle, autoplay;
