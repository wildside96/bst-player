...
public class FlashMP3PlayerImpl {
    ...
    jso[playerId].doID3 = function() {
        try {
            ...
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::year = jso[playerId].parseID3(pInfo.year);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::albumTitle = jso[playerId].parseID3(pInfo.album);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::artists = jso[playerId].parseID3(pInfo.artist);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::comment = jso[playerId].parseID3(pInfo.comment);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::genre = jso[playerId].parseID3(pInfo.genre);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::title = jso[playerId].parseID3(pInfo.songName);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::contentProviders = jso[playerId].parseID3(pInfo.TOLY);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::copyright = jso[playerId].parseID3(pInfo.TOWN);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::hardwareSoftwareRequirements = jso[playerId].parseID3(pInfo.TSSE);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::publisher = jso[playerId].parseID3(pInfo.TPUB);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationOwner = jso[playerId].parseID3(pInfo.TRSO);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationName = jso[playerId].parseID3(pInfo.TRSN);
            listener.@com.bramosystems.gwt.player.core.client.MediaStateListener::onMediaInfoAvailable(Lcom/bramosystems/gwt/player/core/client/MediaInfo;)(id3);
        } catch(e) {
