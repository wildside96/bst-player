...
public class DivXStateManager {
    ...
    public final void init(String playerId, FlashMediaPlayer player, Command initCommand) {
        initGlobalCallbacks(playerId, this);
    ...
    private native void initGlobalCallbacks(String playerId, DivXStateManager impl) /*-{
    $wnd.bstDivXStateChanged + playerId = function(playerId, state, listIndex){
