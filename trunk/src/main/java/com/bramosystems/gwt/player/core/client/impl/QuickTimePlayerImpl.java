...
public class QuickTimePlayerImpl {
    ...
    jso[playerId].errorr = function() {
        listener.@com.bramosystems.gwt.player.core.client.MediaStateListener::onError(Ljava/lang/String;)("An" +
    ...
    jso[playerId].doMetadata = function() {
        try {
            var plyr = $doc.getElementById(playerId);
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::year = plyr.GetUserData("&#xA9;day");
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::albumTitle = plyr.GetUserData("name");
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::artists = plyr.GetUserData('©prf');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::comment = plyr.GetUserData('info');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::title = plyr.GetUserData('name');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::contentProviders = plyr.GetUserData('©src');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::copyright = plyr.GetUserData('cprt');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::hardwareSoftwareRequirements = plyr.GetUserData('©req');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::publisher = plyr.GetUserData('©prd');
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::genre = '';
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationOwner = '';
            id3.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationName = '';
