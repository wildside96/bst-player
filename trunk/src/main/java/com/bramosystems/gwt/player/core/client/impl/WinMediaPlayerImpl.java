    ...
    if(jso[playerId] != null) {
        ...
        jso[playerId].doWMPMetadata = function() {
            try {
                ...
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::title = plyrMedia.getItemInfo('Title');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::copyright = plyrMedia.getItemInfo('Copyright');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::duration = parseFloat(plyrMedia.getItemInfo('Duration')) * 1000;
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::publisher = plyrMedia.getItemInfo('WM/Publisher');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::comment = plyrMedia.getItemInfo('Description');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::year = plyrMedia.getItemInfo('WM/Year');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::albumTitle = plyrMedia.getItemInfo('WM/AlbumTitle');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::artists = plyrMedia.getItemInfo('WM/AlbumArtist');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::contentProviders = plyrMedia.getItemInfo('WM/Provider');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::genre = plyrMedia.getItemInfo('WM/Genre');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationOwner = plyrMedia.getItemInfo('WM/RadioStationOwner');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::internetStationName = plyrMedia.getItemInfo('WM/RadioStationName');
                mData.@com.bramosystems.gwt.player.core.client.MediaInfo::hardwareSoftwareRequirements = plyrMedia.getItemInfo('WM/EncodingSettings');
        ...
        jso[playerId].debug = function(message) {
            listener.@com.bramosystems.gwt.player.core.client.MediaStateListener::onDebug(Ljava/lang/String;)(message);
        };
