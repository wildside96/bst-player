...
public class PlayerUtilImplIE extends PlayerUtilImpl {
    ...
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setMajor(I)(parseInt(ver.charAt(0)));
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setMinor(I)(parseInt(ver.charAt(1)));
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setRevision(I)(parseInt(ver.charAt(2)));
    ax.Quit();
    } catch (e) {
    }
    }-*/;
    ...
    ver = ver.split(".");
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setMajor(I)(parseInt(ver[0]));
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setMinor(I)(parseInt(0));
    version.@com.bramosystems.gwt.player.core.client.PluginVersion::setRevision(I)(parseInt(0));
    ax.Quit();
    } catch (e) {
    }
    }-*/;
