...
public class ViewFactory {
    ...
    private enum Views {
        ...
        dynWmp((UiBinder<Widget, TemplateFactory>) GWT.create(CustomWmp.class)),
        dynSwf((UiBinder<Widget, TemplateFactory>) GWT.create(CustomSwf.class)),
        dynQt((UiBinder<Widget, TemplateFactory>) GWT.create(CustomQt.class)),
        dynVlc((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVlc.class)),
        dynNtv((UiBinder<Widget, TemplateFactory>) GWT.create(CustomNtv.class)),
        dynAuto((UiBinder<Widget, TemplateFactory>) GWT.create(CustomAuto.class)),
        dynvdWmp((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVidWmp.class)),
        dynvdSwf((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVidSwf.class)),
        dynvdQt((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVidQt.class)),
        dynvdVlc((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVidVlc.class)),
        dynvdNtv((UiBinder<Widget, TemplateFactory>) GWT.create(CustomVidNtv.class)),
