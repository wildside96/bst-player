 ...
 */
public class SWFShowcase implements Case {
    private VerticalPanel vp;
    private FlashMP3Player p1, p2;
    ...
    public SWFShowcase() {
        ...
        Widget wmp = null;
        try {
            p1 = new FlashMP3Player(GWT.getHostPageBaseURL() + "media/applause.mp3");
            wmp = p1;
            wmp.setWidth("80%");
        } catch (LoadException ex) {
            Window.alert("Load exp");
        } catch (PluginVersionException ex) {
            wmp = PlayerUtil.getMissingPluginNotice(Plugin.FlashMP3Player);
        ...
        Widget wmp2 = null;
        try {
            p2 = new FlashMP3Player(GWT.getHostPageBaseURL() + "media/thunder.mp3", false);
            wmp2 = p2;
            wmp2.setWidth("80%");
        } catch (LoadException ex) {
            Window.alert("Load exp");
    ...
    public String getSummary() {
        return "Playing sound with Adobe Flash plugin";
    }
