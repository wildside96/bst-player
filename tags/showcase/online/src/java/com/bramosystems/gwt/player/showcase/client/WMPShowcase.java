 ...
 */
public class WMPShowcase implements Case {

    private VerticalPanel vp;
    private WinMediaPlayer p1,  p2;
    ...
    public WMPShowcase() {
        ...
        Widget wmp = null;
        try {
            p1 = new WinMediaPlayer(GWT.getHostPageBaseURL() + "media/applause.mp3", true);
            wmp = p1;
            wmp.setWidth("80%");
        ...
        Widget wmp2 = null;
        try {
            p2 = new WinMediaPlayer(GWT.getHostPageBaseURL() + "media/thunder.mp3", false);
            wmp2 = p2;
            wmp2.setWidth("80%");
        } catch (LoadException ex) {
            Window.alert("Load exp");
