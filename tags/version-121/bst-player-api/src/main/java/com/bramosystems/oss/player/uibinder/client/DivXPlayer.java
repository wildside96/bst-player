...
/**
 * Wrapper class for {@link com.bramosystems.oss.player.core.client.ui.DivXPlayer}
 ...
 *         ...
 *         &lt;player:DixXPlayer autoplay='true' height='20px' width='100%'
 ...
 * @since 1.2
 */
public class DivXPlayer extends PlayerWrapper<com.bramosystems.oss.player.core.client.ui.DivXPlayer> {
    ...
    @Override
    protected com.bramosystems.oss.player.core.client.ui.DivXPlayer initPlayerEngine(String mediaURL, boolean autoplay, String height, String width)
        ...
        com.bramosystems.oss.player.core.client.ui.DivXPlayer mp =
                new com.bramosystems.oss.player.core.client.ui.DivXPlayer(_urls.get(0),
